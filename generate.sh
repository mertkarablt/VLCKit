...
#MACOS_URL="https://download.videolan.org/pub/cocoapods/unstable/VLCKit-3.6.1b1-8e652244-ac310b4b.tar.xz"
#TVOS_URL="https://download.videolan.org/pub/cocoapods/unstable/TVVLCKit-3.6.1b1-8e652244-ac310b4b.tar.xz"
...
PACKAGE_STRING="Target.binaryTarget(name: \"VLCKit-all\", url: \"https:\/\/github.com\/mertkarablt\/VLCKit\/releases\/download\/$TAG_VERSION\/VLCKit-all.xcframework.zip\", checksum: \"$PACKAGE_HASH\")"
